...
<div class="container-fluid container-fullw bg-white">
							<div class="row">
								...
								<div class="col-md-12">
								<p style="color:red;"><?php if(isset($_SESSION['msg'])) echo htmlentities($_SESSION['msg']); ?>
								</p>	
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
										<?php
										$sql=mysqli_query($con,"select doctor.docName,appointments.* from doctor,appointments where doctor.d_id=appointments.d_id and appointments.patientsid='".$_SESSION['id']."'");
										$cnt=1;
