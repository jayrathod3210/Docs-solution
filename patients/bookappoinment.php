<?php
	...
	if(isset($_POST['submit']))
	{
		...
		$userstatus=1;
		$docstatus=1;
		$query=mysqli_query($con,"insert into appointments(doctorSpecialization,d_id,patientsid,consultancyFees,appointmentDate,appointmentTime,patientsStatus,doctorStatus) 
