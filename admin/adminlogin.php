		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<div class="box-login">
					...
					<p>
						<center>  <img src="images/demo/receptionist (2).jpg" alt="" width="178" height="208" /></center>
					</p>
					...
					<div class="copyright">
						<span>	Designed By | JAY RATHOD, NISHIT PANCHAL<br>    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SHUBHAM PATEL & RUTVIK PATEL | &copy;<?php echo date('Y')?> all right reserved &copy;<?php echo date('Y')?></span>
					</div>
