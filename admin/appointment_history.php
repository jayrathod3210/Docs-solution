		...
		<div class="app-content">
			...
			<div class="main-content" >
				...
				<div class="col-sm-offset-1 col-md-10">
					<h1>APPOINTMENT HISTORY</h1><br><br><br>
					<!-- start: BASIC EXAMPLE -->
							...
							<div class="row">
								<div class="col-md-12">
									...
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
										<?php
											$sql=mysqli_query($con,"select doctor.docName as docname,patients.fullName as pname,appointments.*  from appointments join doctor on doctor.d_id=appointments.d_id join patients on patients.id=appointments.patientsid");
											$cnt=1;
											...
											<td class="hidden-xs"><?php echo $row['docname'];?></td>
												...
												<td>
													...
													if(($row['patientsStatus']==1) && ($row['doctorStatus']==0)){
														echo "<P><font color=red>Cancel by Doctor</font></p>";
													}?>
												</td>
