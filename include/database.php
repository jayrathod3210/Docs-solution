<?php
	...
	{
		$specilization=$row['docSpecialization'];
		$doctorid=$row['doctor'];
		$patientsid=$row['id'];
		$fees=$row['fees'];
		$appdate=$row['appdate'];
		...
		$userstatus=1;
		$docstatus=1;
		$sql = " INSERT INTO appointments(docSpecialization,d_id,patientsid,consultancyFees,appointmentDate,appointmentTime,patientsStatus,doctorStatus)
		VALUES('" . $_POST["docSpecialization"] . "','" . $_POST["doctor"] . "','" . $_POST["id"] . "','" . $_POST["fees"] . "', '" . $_POST["appdate"] . "','" . $_POST["apptime"] . "' )";
		if($sql)
		{
												...
												<form role="form" name="book" method="post" >
													...
													<div class="form-group">
															...
															<select name="docSpecialization" class="form-control" onChange="getdoctor(this.value);" required="required">
																...
																<?php $ret=mysql_query("select * from doc_specialization");
													...
													<label>
														<input type="hidden" name="userid" value="<?php echo $patientsid; ?>">
													</label>
