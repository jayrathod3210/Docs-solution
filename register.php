<?php
	...
	if(isset($_POST['submit']))
	{
		...
		$query=mysqli_query($con,"insert into patients(fullName,address,city,contactno,gender,email,password)values('$fname','$address','$city','$contactno','$gender','$email','$password')");
		if($query)
		{
...
<html lang="en">
	...
	<body class="login" style="background-color:#95B9C7">
		<!-- start: REGISTRATION -->
		<div class="row">
