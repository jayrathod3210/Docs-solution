...
<?php 
	...
	if(isset($_POST['submit']))
	{
		...
		$sql= "select * from doctor where docemail='$docemail' and password='$password'";
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<div class="box-login">
						...
						<fieldset>
							...
							<div class="form-group">
								<span class="input-icon">
									<input type="text" class="form-control" name="docemail" placeholder="Username" autocomplete="off">
					...
					<div class="copyright">
							<h6>	Designed By | JAY RATHOD, NISHIT PANCHAL<br>    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SHUBHAM PATEL & RUTVIK PATEL | &copy;<?php echo date('Y')?></h6>all right reserved</p>
