<?php
	...
	{
		$sql=mysql_query("SELECT password FROM  doctor where password='".md5($_POST['cpass'])."' && docName='".$_SESSION['docName']."'");
		$num=mysql_fetch_array($sql);
		if($num>0)
		{
			$con=mysql_query("update doctor set password='".md5($_POST['npass'])."', updationdate='$currentdate' where docName='".$_SESSION['docName']."'");
											...
											<div class="panel panel-white">
												...
												<?php echo htmlentities($_SESSION['msg1']="");?></p>	
													<form role="form" name="chngpwd" method="post" onSubmit="return valid();">
														...
														<input type="password" name="cfpass" class="form-control"  placeholder="Enter Current Password">
														</div>
														<div class="form-group">
		...
		<!-- end: CLIP-TWO JAVASCRIPTS -->
			...
			<?php 
							...
							if($row>0){
								...
								$sql1="UPDATE doctor SET password='" . $_POST["newpassword"]  ."' WHERE docName='" .$_SESSION["email"] ."'";
